...
```sh
DEEPGRID_DEBUG_SHOT=1      ./docker/deepgrid-run.sh   # メイン画面(HUD付き)
DEEPGRID_DEBUG_SHOT=fall   ./docker/deepgrid-run.sh   # 落下ダメージ
DEEPGRID_DEBUG_SHOT=ladder ./docker/deepgrid-run.sh   # はしご昇降
DEEPGRID_DEBUG_SHOT=door   ./docker/deepgrid-run.sh   # ドア開閉
DEEPGRID_DEBUG_SHOT=props  ./docker/deepgrid-run.sh   # 3Dモデル配置
DEEPGRID_DEBUG_SHOT=editor ./docker/deepgrid-run.sh   # マップエディター
```
